...
type IndexPageQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly frontmatter: { readonly title: string | null, readonly slug: string | null, readonly date: string | null, readonly featuredImage: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null, readonly internal: { readonly contentFilePath: string | null } }> } };
...
type PostTemplateQuery = { readonly mdx: { readonly frontmatter: { readonly title: string | null, readonly slug: string | null, readonly date: string | null } | null } | null };
